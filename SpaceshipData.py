...
class SpaceshipData:
    ...
    def evolve(self, keys, newkeys, buttons, newbuttons, mouse_position):
        ...
        if self.screen_manager.display_hud == True:
            self.screen_manager.hud.update(Globals.spaceship.score, Globals.spaceship.ammo, Globals.spaceship.health, Globals.spaceship.missed, Globals.spaceship.gamedifficulty)
